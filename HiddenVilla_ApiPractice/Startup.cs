...
namespace HiddenVilla_ApiPractice
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Set up bearer token authentication method
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "HiddenVilla_ApiPractice", Version = "v1" });

                // Enable Bearer Tokens in Swagger
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "HiddenVilla_ApiPractice v1"));
            }
